      ...
      class NestedAccordion extends s.default {
        ...
        updateIndexValues() {
          ...
          t.each((t, s) => {
            s.setAttribute("id", `${n}${t}`),
              s
                .querySelector(i.selectors.accordionItemTitles)
                .setAttribute(i.attributes.index, t + 1),
              s
                .querySelector(i.selectors.accordionItemTitles)
                .setAttribute("aria-controls", `${n}${t}`),
              s
                .querySelector(i.selectors.accordionItemTitlesText)
        ...
        clickListener(e) {
          ...
          "one" === r && this.closeAllItems(a, l),
            i.open
              ? this.closeAccordionItem(i, s)
              : this.prepareOpenAnimation(i, s, o);
        }
        animateItem(e, t, i, n) {
