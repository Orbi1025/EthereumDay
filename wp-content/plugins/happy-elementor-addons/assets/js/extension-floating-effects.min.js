(() => {
  jQuery(window).on("elementor/frontend/init", function () {
    var s,
      ...
      e = elementorModules.frontend.handlers.Base.extend({
        ...
        getFloatingTarget: function () {
          var t = 0 < this.findElement(".elementor-widget-container").length;
          return elementorFrontendConfig.experimentalFeatures.hasOwnProperty(
            "e_optimized_markup"
          ) &&
            1 ==
            ...
            !t
            ? this.$element
            : this.findElement(".elementor-widget-container");
        },
    ...
    elementorFrontend.hooks.addAction(
      ...
      function (t) {
        elementorFrontend.elementsHandler.addHandler(e, { $element: t });
      }
    );
  });
})();
